...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/CYRUSSTAINES/tdusicadvancebot",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/Td_networkk")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/Tdxsupport")
